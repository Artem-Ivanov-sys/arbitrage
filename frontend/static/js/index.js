...
function createRow(data) {
  ...
  <tr>
      ...
      <td class="coin-name" rowspan="2"><span class="badge ${((data['long']['rate'] - data['short']['rate']) >= 0 ? 'green' : 'red')}">   ${((data['long']['rate'] - data['short']['rate'])*100).toFixed(4)}% </span></td>
      <td class="coin-name" rowspan="2">
  <span class="badge ${
    data['short']['index_price'] && data['long']['index_price'] &&
    ((data['short']['index_price'] - data['long']['index_price']) * 2 / (data['long']['index_price'] + data['short']['index_price'])) >= 0
      ? 'green'
      : 'red'
  }">
    ${data['short']['index_price'] && data['long']['index_price']
      ? (((data['short']['index_price'] - data['long']['index_price']) * 2 / (data['long']['index_price'] + data['short']['index_price'])) * 100).toFixed(4)
      : -1}%
  </span>
</td>
